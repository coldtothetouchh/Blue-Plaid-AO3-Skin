...
1. Copy the code provided [here](https://github.com/coldtothetouchh/Blue-Plaid-AO3-Skin/blob/main/CSS%20Code). There is a copy button at the top of the code box in github.
